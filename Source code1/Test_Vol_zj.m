...
% tic;
tic;
[  vX, vY, vZ, iCloudLength, ~, vFace ] = Func_ContourV2( CubePoints, step_num_1, step_num_2, step_num_3, LUT  );
[  vX1, vY1, vZ1, iCloudLength1, ~, vFace1 ] = Func_ContourV2( CubePoints1, step_num1_1, step_num1_2, step_num1_3, LUT  );
vX1=vX1+10;
